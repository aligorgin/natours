            ...
            <div className='w-3/4 bg-white shadow-darkL rounded-[3px]'>
                ...
                <div className='flex h-full'>
                    ...
                    <div className='flex-1 w-2/3 py-[3rem] px-[5rem] relative'>
                        <div onClick={()=>{setClick(false)}} className='absolute top-12 right-12 flex flex-col'>
                            <div className='w-[3rem] h-[2px] bg-gray-600 absolute rotate-45'></div>
                            <div className='w-[3rem] h-[2px] bg-gray-600 -rotate-45 ' ></div>
                        </div>
