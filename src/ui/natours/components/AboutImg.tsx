...
export default function AboutImg({img, className}: Props) {
    return (
        <div
            className={clsx('composition__photo w-1/3 lg:w-[55%] shadow-semiDarkSuperLow lg:shadow-semiDark rounded-[2px] float-left lg:absolute transition-all duration-200  top-[-2rem] hover:scale-105 hover:shadow-dark hover:z-20 hover:outline-xl hover:translate-y-[-.5rem] ', className)}>
